...
export default class CTF {
  ...
  async setInfoCategory(info_category_snowflake: string) {
    ...
    logger(
      `Set **${this.row.name}**'s info category to **${info_category_snowflake}**`,
    );
  }
  ...
  async setTOSChannel(tos_channel_snowflake: string) {
    ...
    logger(
      `Set **${this.row.name}**'s TOS channel to **${tos_channel_snowflake}**`,
    );
  }
  ...
  async setTOSWebhook(tos_webhook_snowflake: string) {
    ...
    logger(
      `Set **${this.row.name}**'s TOS webhook to be **${tos_webhook_snowflake}**`,
    );
  }
